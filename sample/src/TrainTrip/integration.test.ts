...
beforeEach(bind(async () => {
  ...
  const result = await root.getHandler(createTrainTrip)({
...
describe('get', () => {
  it('works', bind(async () => {
    const result = await root.getHandler(getTrainTrip)({ trainTripId })
...
describe('propose new state', () => {
  it('changes state accordingly', bind(async () => {
    ...
    const result = await root.getHandler(changeTrainTrip)({ trainTripId, ...state })
  ...
  it('errors on non existent travel class', bind(async () => {
    ...
    const r = await root.getHandler(changeTrainTrip)({ trainTripId, ...state })
...
describe('able to lock the TrainTrip', () => {
  it('changes state accordingly', bind(async () => {
    ...
    const result = await root.getHandler(lockTrainTrip)({ trainTripId })
...
describe('register Cloud', () => {
  it('works', bind(async () => {
    const result = await root.getHandler(registerCloud)({ trainTripId })

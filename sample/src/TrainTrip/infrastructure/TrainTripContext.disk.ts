...
import ContextBase, { RecordContext } from 'fp-app-framework/src/infrastructure/context.base'
import { DiskRecordContext } from 'fp-app-framework/src/infrastructure/diskdb'
import { DbError } from 'fp-app-framework/src/infrastructure/errors'
import { map, mapErr } from 'fp-app-framework/src/utils/neverthrow-extensions'
...
export default class DiskDBContext extends ContextBase implements TrainTripContext {
  public get trainTrips() { return this.trainTripsi as RecordContext<TrainTrip> }
